...
/// \brief ParametersBase A base struct for struct generated by rosparam_handler.
...
protected:
  ...
  //{
  //  ROS_FATAL_STREAM("Called function fromConfigImpl with unknown input argument type.");
  //  rosparam_handler::exit("Called function fromConfigImpl with unknown input argument type.");
  //}
